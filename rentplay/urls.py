...
urlpatterns = [
    ...
    path('agencies/<slug:agency_slug>/about/', views.agency_about, name='agency_about'),
    ...
    path('property/<int:property_pk>/report/', views.property_report, name='property_report'),
    ...
    path('dashboard/properties/<int:pk>/toggle-status/', views.property_toggle_status, name='toggle_property_status'),
