...
class Property(models.Model):
    ...
    building_number = models.CharField('رقم المبنى', max_length=20, blank=True, help_text='رقم المبنى من العنوان الوطني (اختياري)')
    postal_code = models.CharField('الرمز البريدي', max_length=10, blank=True, help_text='الرمز البريدي (اختياري)')
