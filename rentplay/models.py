...
class Property(models.Model):
    ...
    price_annual = models.DecimalField('السعر السنوي (ريال)', max_digits=12, decimal_places=2, default=0, validators=[MinValueValidator(0)])
    ...
    def save(self, *args, **kwargs):
        """Force is_published=True — all properties are always published."""
    ...
    @property
    def main_image(self):
        """Return default placeholder (no images in v4)."""
