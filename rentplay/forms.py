...
class PropertyForm(forms.ModelForm):
    ...
    class Meta:
        model = Property
        fields = [
            'unit_code', 'title', 'description', 'property_type', 'video',
            'city', 'district', 'rooms', 'bathrooms', 'area', 'floor',
            'price_annual', 'price', 'payment_period', 'status', 'rent_end_date',
        ...
        widgets = {
            ...
            'price_annual': forms.NumberInput(attrs={'class': 'form-input', 'min': 0}),
