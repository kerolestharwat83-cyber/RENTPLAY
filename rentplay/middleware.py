...
class RoleBasedAccessMiddleware:
    ...
    def process_request(self, request):
        ...
        # Django admin access: require is_staff=True AND (is_superadmin OR is_superuser)
        if path.startswith(ADMIN_PATH):
            if not user.is_staff:
                return HttpResponseForbidden(_('Access denied. Only staff users can access this area.'))
